...
public final class ReflectionUtils {
    ...
    public static enum PackageType {
        MINECRAFT_SERVER("MINECRAFT_SERVER", 0, "net.minecraft.server." + PackageType.getServerVersion()),
        CRAFTBUKKIT("CRAFTBUKKIT", 1, "org.bukkit.craftbukkit." + PackageType.getServerVersion()),
        ...
        private PackageType(String s, int n2, String path) {
            this.path = path;
        }
